...
public class IndexController {
	...
	public String updateAvatarUrl(MultipartFile paramName, HttpServletRequest request) throws IOException {
		...
		String filename = paramName.getOriginalFilename();//获取file图片名称
		//String uploadFile = FtpUtils.uploadFile(filePath, paramName.getBytes(), UUID.randomUUID().toString().replaceAll("-", "") + ".jpg");
	     FtpUtils.uploadFile(filePath, filename+".jpg", paramName.getBytes());
